package com.example.mediatest.service;
                ...
                while (true) {
                    try {
                        if (mMediaPlayer.isPlaying()) {
                            ...
                            bundle.putLong(Comment.SEEKTO_CURRENT_POSITION, mMediaPlayer.getCurrentPosition());
                            bundle.putLong(Comment.SEEKTO_DURATION, mMediaPlayer.getDuration());
