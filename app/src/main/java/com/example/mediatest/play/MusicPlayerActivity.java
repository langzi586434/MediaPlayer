...
import com.example.mediatest.base.BaseMediaActivity;
...
//        Glide.with(this).load(R.drawable.down).into((ImageView) findViewById(R.id.center_img));
