package com.example.mediatest.base;
...
import com.example.mediatest.service.MediaSessionService;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Comment.SEEKTO:
                    ...
                    long currentPosition = state.getLong(Comment.SEEKTO_CURRENT_POSITION, 0);
                    long duration = state.getLong(Comment.SEEKTO_DURATION, 0);
